...
## Alexandre Adalardo de Oliveira, versao: 09 novembro 2009
#log: calcula area basal para individuos em parcelas distintas onde pode haver repeticao do numero "tag' (abasal.parcela)
# resolvido problema de somatoria da area basal de fustes multiplos
#options(help_type="html")
##########################
#### DAP da base de dados
##########################
## fustes distintos de mesmo individuo separados por ;
######################################################
# duas opcoes 
### formato longo: cada fuste uma linha
### DADOS TESTE  #
                                        #
